...
export const SKILLS_DATA: NavData[] = [
  {
    title: "语言",
    items: [
      {
        icon: "/svg/css.svg",
        title: "CSS",
        desc: "CSS 是一种用于描述 HTML 文档外观和格式的样式表语言",
        link: "https://developer.mozilla.org/zh-CN/docs/Web/CSS"
      },
      {
        icon: "/svg/html.svg",
        title: "HTML",
        desc: "HTML 是一种用于描述网页结构和内容的标记语言",
        link: "https://developer.mozilla.org/zh-CN/docs/Web/HTML"
      },
      {
        icon: "/svg/js.svg",
        title: "JavaScript",
        desc: "JavaScript 是一种用于创建交互式网页的编程语言",
        link: "https://developer.mozilla.org/zh-CN/docs/Web/JavaScript"
      },
      {
        icon: "/svg/ts.svg",
        title: "TypeScript",
        desc: "TypeScript 是一种强类型编程语言，它建立在 JavaScript 的基础上，为任何规模的项目提供更好的工具",
        link: "https://www.typescriptlang.org"
      },
      {
        icon: "/svg/python.svg",
        title: "Python",
        desc: "Python 是一种让您快速工作的编程语言并且更有效地集成系统",
        link: "https://www.python.org"
      },
      {
        icon: "/svg/sass.svg",
        title: "Sass",
        desc: "Sass 是世界上最为成熟、稳定和强大的专业级 CSS 扩展语言",
        link: "https://sass-lang.com/"
      },
      {
        icon: "/svg/less.svg",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "uniapp",
        desc: "uniapp 是一个基于 Vue.js 的跨平台开发框架",
        link: "https://uniapp.dcloud.net.cn"
      },
      {
        icon: "/svg/react.svg",
      ...
      },
      {
        icon: "/svg/nextjs.svg",
        title: "Next.js",
        desc: "适用于 web 开发的 React 框架",
        link: "https://nextjs.org"
      },
      {
        icon: "/svg/umi.svg",
        title: "Umi",
        desc: "Umi 是一个可插拔的企业级 react 应用框架",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "/svg/nestjs.svg",
        title: "Nest.js",
        desc: "一个用于构建高效、可靠和可扩展服务器端应用的渐进式 Node.js 框架",
      ...
      },
      {
        icon: "/svg/koa.svg",
        title: "Koa",
        desc: "下一代 Node.js 网络框架",
        link: "https://koajs.com"
      },
      {
        icon: "https://www.eggjs.org/favicon.png",
        title: "Egg",
        desc: "更好的 Node.js & Koa 企业级框架和应用",
        link: "https://www.eggjs.org/zh-CN"
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "shadcn/ui",
        desc: "一套精美设计、易于访问的组件和代码分发平台。与您喜爱的框架兼容",
        link: "https://ui.shadcn.com/"
      },
      {
        icon: "https://www.radix-ui.com/favicon.png",
        title: "radix-ui",
        desc: "一个针对快速开发、易于维护和可访问性优化的开源组件库。直接导入即可使用——无需配置",
        link: "https://www.radix-ui.com/"
      },
      {
        icon: "https://uviewui.com/favicon.ico",
        title: "UView",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "https://lbsyun.baidu.com/favicon.ico"
      }
    ]
  },
  {
    ...
    items: [
      {
        title: "Neon",
        desc: "您喜爱的数据库，在一个无服务器平台上，旨在帮助您更快地构建可靠且可扩展的应用程序。",
        link: "https://neon.tech/",
        icon: "https://neon.tech/favicon.ico"
      },
      {
        title: "Supabase",
        desc: "Supabase 是一个开源的 Firebase 代替方案。以 Postgres 数据库、身份验证、即时 API、边缘函数、实时订阅、存储和向量嵌入开始您的项目。",
        link: "https://supabase.com/",
        icon: "https://supabase.com/favicon/favicon-32x32.png"
      },
      {
        title: "MySQL",
        desc: "MySQL是一款开源关系型数据库管理系统，用于高效存储和管理结构化数据",
        link: "https://www.mysql.com/",
        icon: "/svg/mysql.svg"
      },
      {
        title: "MongoDB",
        desc: "MongoDB 是一个基于分布式文件存储的数据库",
        link: "https://www.mongodb.com/",
        icon: "https://www.mongodb.com/favicon.ico"
      },
      {
        title: "Redis",
        desc: "使用最快的缓存，提供更快的体验",
        link: "https://redis.io/",
  ...
  },
  {
    ...
    items: [
      {
        title: "Vite",
        desc: "Vite 是一款极速的前端构建工具，为下一代 Web 应用提供动力。",
        link: "https://vitejs.dev/",
        icon: "https://vitejs.dev/logo.svg"
      },
      {
        title: "Webpack",
        desc: "Webpack是一个前端模块打包工具，用于将各种资源（如JS、CSS、图片等）打包成静态文件",
        link: "https://webpack.js.org/",
        icon: "https://webpack.js.org/icon_192x192.png"
      },
      {
        title: "Rollup",
        desc: "将小块代码编译成更大、更复杂的结构",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Cursor",
        desc: "为引导您进入惊人的生产力而打造。Cursor 是利用 AI 编写代码的最佳工具。",
        link: "https://www.cursor.com/"
      },
      {
        icon: "https://www.jetbrains.com/favicon.ico",
        title: "JetBrains",
        desc: "JetBrains 是一家捷克公司，专门从事开发智能的移动和桌面应用程序的工具",
      ...
      {
        title: "Animate.css",
        desc: "Animate.css是一个开源的CSS动画库，提供60多种预定义动画效果，如淡入、缩放和旋转等",
        link: "https://animate.style/",
        icon: "https://animate.style/img/favicon.ico"
      },
      {
        title: "Prettier",
        desc: "Prettier 是一款自动代码格式化工具，支持多种语言，统一代码风格",
        link: "https://prettier.io/",
        icon: "https://prettier.io/icon.png"
      },
      {
        title: "ESLint",
        desc: "ESLint 静态分析您的代码以快速查找问题。它已集成到大多数文本编辑器中，您可以将 ESLint 作为持续集成管道的一部分运行",
      ...
      {
        title: "Jenkins",
        desc: "领先的开源自动化服务器，Jenkins 提供了数百个插件来支持构建、部署和自动化任何项目。",
...

      {
        ...
        icon: "https://lodash.com/favicon.ico"
      },
      {
        title: "Axios",
        desc: "Axios 是一个简单的基于 Promise 的浏览器和 node.js HTTP 客户端。Axios 提供了一个小巧的库，易于使用，并且具有非常可扩展的接口。",
        link: "https://axios-http.com/",
        icon: "https://axios-http.com/assets/favicon.ico"
      },
      {
        title: "Moment.js",
        desc: "解析、验证、操作和显示 JavaScript 中的日期和时间。",
        link: "https://momentjs.com/",
        icon: "https://momentjs.com/static/img/moment-favicon.png"
      },
      {
        title: "Day.js",
        desc: "快速 2KB 替代 Moment.js，具有相同的现代 API",
